...
export default function Chat() {
  ...
  const showAllChatAll = showAllChat.map((chat) => (
    ...
    >
      <img className="Img-Profile" src={chat.userOther[0].imgChat? pathWeb+chat.userOther[0].imgChat:ImgProfileIsEmpty} />
  ...
  const showAllSearch = resultSearch.map((user) => (
    ...
    >
      <img className="Img-Profile-search" src={ImgProfileIsEmpty} />
    ...
    <div className="chat-main">
      {((widthPage < 700 && chatId !== "") || widthPage >= 700) && (
        <div className="Message-to-chat">
          {chatId ? (
            <ListMessage id={chatId} onButtombackChat={backToChat} img={imgChat} />
          ) : (
